                            ...
                            child: RichText(
                              text: const TextSpan(
                                children: [
                                  ...
                                  TextSpan(
                                    text:
                                        "  The advantages of the Home Office. Increased productivity. The colleagues from the department have a short chat while you try to work highly concentrated yourself.",
                                    style: TextStyle(
                                      color: Colors.white,
                                    ),
                                  ),
